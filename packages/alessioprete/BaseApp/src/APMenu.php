...
use alessioprete\BaseApp\app\Models\Menus;
use alessioprete\BaseApp\app\Models\MenuItems;
...
class APMenu
{
    ...
    public function render()
    {
        ...
        if ((request()->has("action") && empty(request()->input("menu"))) || request()->input("menu") == '0') {
            return view(alessioprete_view('auth.menu-html'))->with("menulist" , $menulist);
        } else {
            ...
            return view(alessioprete_view('auth.menu-html'), $data);
        }
    ...
    {
        return view(alessioprete_view('auth.scripts'));
    }
