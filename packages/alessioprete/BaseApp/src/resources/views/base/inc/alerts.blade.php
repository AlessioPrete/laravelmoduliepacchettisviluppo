...
<script type="text/javascript">
    ...
    document.onreadystatechange = function() {
        if (document.readyState == "interactive") {
            ...
            var $alerts_from_localstorage = JSON.parse(localStorage.getItem('alessioprete_alerts')) ?
                JSON.parse(localStorage.getItem('alessioprete_alerts')) : {};
            ...
            localStorage.removeItem('alessioprete_alerts');
        }
    };
</script>
