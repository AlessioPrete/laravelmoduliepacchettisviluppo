...
<link href="{{asset('packages/alessioprete/base/css/menu.css')}}" rel="stylesheet">
<div id="hwpwrap">
                        ...
                        <div class="wrap">
                            <div class="manage-menus">
                                <form method="get" action="{{ $currentUrl }}">
                                    <label for="menu" class="selected-menu">Seleziona il menu che vuoi gestire:</label>

                                    {!! APMenu::select('menu', $menulist) !!}
                                                            ...
                                                            <div class="inside">
                                                                <div class="customlinkdiv" id="customlinkdiv">
                                                                    ...
                                                                    <p class="button-controls">
                                                                        ...
                                                                        <a  href="#" onclick="addcustommenu()"  class="button-secondary submit-add-to-menu right"  >Aggiungi elemento</a>
